...
{
	public static var psychEngineVersion:String = '3.0.1'; //This is also used for Discord RPC
	public static var curSelected:Int = 0;
	public static var curInSelect:Int = 0;
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In the Main menu", optionShit[curSelected]);
		#end
		...
		var bg:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('menuother/menuBG'));
		...
		if (!selectedSomethin)
		{
			if (controls.UI_DOWN_P || controls.UI_UP_P){
				...
				FlxTween.tween(personajes,{x: 600, alpha : 0},0.2,{ease:FlxEase.cubeIn,onComplete: function(twn:FlxTween)
					{
						personajes.loadGraphic(Paths.image('menumod/personajes/' + optionShit[curInSelect]));
